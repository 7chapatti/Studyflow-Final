...
//      assignment's own daily target and the shared global daily budget.
//   2. Drop the gap requirement, keep both daily preferences.
//   3. Drop the global budget too, keep just this assignment's own target
//      (the original per-assignment-only behaviour).
