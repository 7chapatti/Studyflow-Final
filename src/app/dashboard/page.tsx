    ...
    <div className="max-w-2xl mx-auto px-4 py-8">
      <header className="flex items-center justify-between mb-6">
        ...
        <Link
          ...
          className="flex items-center gap-1.5 bg-indigo hover:bg-il text-ink text-sm font-medium rounded-lg px-3 py-2 transition-colors"
        >
          <PlusIcon size={15} />
          New assignment
        </Link>
                ...
                >
                  <div className="flex items-start justify-between gap-3 mb-3">
                    <div className="flex-1 min-w-0">
                      <h2 className="text-text text-sm font-medium font-display truncate group-hover:text-il transition-colors">
                        {asgn.name}
                      </h2>
